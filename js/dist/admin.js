...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EditFooterLinksModal; });
...
var EditFooterLinksModal = /*#__PURE__*/function (_Modal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__["default"])(EditFooterLinksModal, _Modal);
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    this.links = flarum_common_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()(app.data.settings['afrux-theme-base.footer_links'] && JSON.parse(app.data.settings['afrux-theme-base.footer_links']) || []);
  };
  ...
  _proto.content = function content() {
    ...
    return m("div", {
      ...
      return m("div", {
        ...
        oninput: function oninput(e) {
          _this.saveGroup(Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, group, {
    ...
    }), m("div", null, m(flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_3___default.a, {
      className: "Button Button--primary",
      onclick: function onclick() {
        flarum_admin_utils_saveSettings__WEBPACK_IMPORTED_MODULE_6___default()({
          'afrux-theme-base.footerLinks': JSON.stringify(_this.links())
        });
      }
    }, app.translator.trans('core.lib.edit_user.submit_button')), m(flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_3___default.a, {
      className: "Button Button--primary",
...
}(flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a);
...
app.initializers.add('afrux-theme-base', function () {
  ...
  if (footerHooked) {
    app.extensionData["for"](currentThemeId).registerSetting(function () {
      ...
      return m("div", {
        className: "Form-group"
      }, m("label", null, app.translator.trans('afrux-theme-base.admin.settings.edit_footer_links')), m(flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_19___default.a, {
        className: "Button",
        onclick: function onclick() {
  ...
  if (normalizeStatusWidgetStructure) {
    Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["override"])(flarum_admin_components_StatusWidget__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'className', function (original) {
      return original() + " ThemeBase-StatusWidget";
    });
    Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["override"])(flarum_admin_components_StatusWidget__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'content', function (original) {
  ...
  if (normalizeAdminHeaderStructure) {
    Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["override"])(flarum_admin_components_AdminHeader__WEBPACK_IMPORTED_MODULE_5___default.a.prototype, 'view', function (original, vnode) {
      var _this = this;

      switch (this.attrs.className) {
        case 'DashboardPage-header':
          this.handleClearCache = flarum_admin_components_StatusWidget__WEBPACK_IMPORTED_MODULE_2___default.a.prototype.handleClearCache;

          this.controls = function () {
            return m(flarum_common_components_Dropdown__WEBPACK_IMPORTED_MODULE_18___default.a, {
              label: app.translator.trans('core.admin.dashboard.tools_button'),
              icon: "fas fa-cog",
              buttonClassName: "Button",
              menuClassName: "Dropdown-menu--right"
            }, m(flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_19___default.a, {
        ...
        case 'ThemeBase-ExtensionsPage-header':
          this.controls = function () {
            var buttonGroup = flarum_admin_components_ExtensionsWidget__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.controlItems().toArray()[0].children;
    ...
    Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["override"])(flarum_admin_components_ExtensionPage__WEBPACK_IMPORTED_MODULE_6___default.a.prototype, 'header', _components_ExtensionPage__WEBPACK_IMPORTED_MODULE_20__["default"].prototype.header);
  }

  if (normalizeExtensionPageStructure) {
    Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["override"])(flarum_admin_components_ExtensionPage__WEBPACK_IMPORTED_MODULE_6___default.a.prototype, 'view', _components_ExtensionPage__WEBPACK_IMPORTED_MODULE_20__["default"].prototype.view);
    Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["override"])(flarum_admin_components_ExtensionPage__WEBPACK_IMPORTED_MODULE_6___default.a.prototype, 'content', _components_ExtensionPage__WEBPACK_IMPORTED_MODULE_20__["default"].prototype.content);
  }

  if (normalizeUserTable) {
    Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_admin_components_UserListPage__WEBPACK_IMPORTED_MODULE_7___default.a.prototype, 'columns', function (columns) {
      columns.add('avatar', {
    ...
    Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_admin_components_UserListPage__WEBPACK_IMPORTED_MODULE_7___default.a.prototype, 'onupdate', function (vnode) {
      this.$('.UserList-emailIconBtn').removeClass('Button--text');
    });
    Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_admin_components_UserListPage__WEBPACK_IMPORTED_MODULE_7___default.a.prototype, 'content', function (vnode) {
      vnode[0] = m("div", {
  ...
  if (addExtensionsPage) {
    ...
    Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["override"])(flarum_admin_components_AdminNav__WEBPACK_IMPORTED_MODULE_13___default.a.prototype, 'view', function () {
      var items = this.items();
      items.remove('search');
      items.remove('category-core');
      items.add('extensions', m(flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_15___default.a, {
        href: app.route('extensions'),
        icon: "fas fa-puzzle-piece",
        title: app.translator.trans('afrux-theme-base.admin.extensions'),
        active: ['extension', 'extensions'].includes(app.current.data.routeName)
      }, m("span", null, app.translator.trans('afrux-theme-base.admin.extensions')), app.current.data.extension ? m("span", {
        className: "ThemeBase-extensions-nav-current"
      }, app.current.data.extension) : []));
      return m(flarum_common_components_SelectDropdown__WEBPACK_IMPORTED_MODULE_14___default.a, {
        className: "AdminNav App-titleControl AdminNav-Main",
        buttonClassName: "Button"
      }, items.toArray().concat());
    });
    Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_admin_components_DashboardPage__WEBPACK_IMPORTED_MODULE_16___default.a.prototype, 'availableWidgets', function (items) {
      items.remove('extensions');
    });
    Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_common_components_Navigation__WEBPACK_IMPORTED_MODULE_17___default.a.prototype, 'getBackButton', function (button) {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_admin_components_ExtensionPage__WEBPACK_IMPORTED_MODULE_6___default.a.prototype, 'oninit', _components_ExtensionPage__WEBPACK_IMPORTED_MODULE_20__["default"].prototype.oninit);
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_admin_components_HeaderSecondary__WEBPACK_IMPORTED_MODULE_4___default.a.prototype, 'items', function (items) {
